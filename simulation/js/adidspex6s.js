...
b43 = new LeaderLine(b4, LeaderLine.pointAnchor(b3, {x: '0%', y: '80%'}),
 ...
 /*  numSamples=fre1;
  sampleRate=fre2;
  const fft = new FFT(numSamples, sampleRate);
      fft.forward(stsa);
      var spectrum = fft.spectrum; */
      
      // for (let i = 0; i < spectrum.length; i++) {
      //   const x = i * canvasWidth / spectrum.length;
      //   const y = canvasHeight - spectrum[i] * canvasHeight;
      //   ctx.lineTo(x, y);
      // }
  function plt(cha){
    st=[];
    ...
    var len=1024;
                ...
                // var filter = new IIRFilter(DSP.LOWPASS, 200,0, 44100);
                // filter.process(st);
                // console.log(filter);
                ...
                var op2 = {
                  ...
                  name: 'Output(Vo)',
                    ...
                    if(cha=='1'){
                      ...
                      var data = [op1];
                      var layout={title: 'Magnitude Spectrum (Vo)', plot_bgcolor: 'black',paper_bgcolor:'black',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
                      ...
                      var data = [in1,op1];
                      var layout={title: 'DFT Magnitude spectrum plot',plot_bgcolor:'black', paper_bgcolor:'black',text_color:'blue',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
